...
Pod::Spec.new do |s|
  s.name         = 'AITrustWalletCore'
  s.version      = version
  s.summary      = 'Trust Wallet core data structures and algorithms.'
  s.homepage     = 'https://github.com/rohitsethii/wallet-core'
  s.license      = 'MIT'
  s.authors      = { 'Rohit Sethi' => 'rohitsethiii836@gmail.com' }
  ...
  s.subspec 'Core' do |ss|
    ...
    ss.xcconfig = {
      'HEADER_SEARCH_PATHS' => '$(inherited) ' \
        '${PODS_ROOT}/AITrustWalletCore/src ' \
        '${PODS_ROOT}/AITrustWalletCore/trezor-crypto/src',
      'SYSTEM_HEADER_SEARCH_PATHS' => '$(inherited) ' \
        '/usr/local/include' \
        '${PODS_ROOT}/AITrustWalletCore/include ' \
        '${PODS_ROOT}/AITrustWalletCore/trezor-crypto/include ' \
        "${PODS_ROOT}/AITrustWalletCore/#{protobuf_source_dir}/src " \
        "${PODS_ROOT}/AITrustWalletCore/#{include_dir} ",
    ...
    ss.dependency 'AITrustWalletCore/Types'
  end
