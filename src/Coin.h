...
#include <AITrustWalletCore/TWBlockchain.h>
#include <AITrustWalletCore/TWCoinType.h>
#include <AITrustWalletCore/TWCurve.h>
#include <AITrustWalletCore/TWHDVersion.h>
#include <AITrustWalletCore/TWPurpose.h>
